...
/**
 * Prüft ob 1Password CLI installiert ist.
 * @returns {boolean} - true wenn installiert
 */
export function isOnePasswordCLIInstalled() {
  try {
...
/**
 * Prüft die 1Password CLI als Pflicht-Tool für Boilerplate 3.0.
 *
 * @param {Object} progressBar - Progress Bar Objekt (optional)
 * @param {boolean} silent - Keine Konsolenausgabe
 * @returns {Promise<void>}
 */
export async function checkOnePasswordCLI(progressBar = null, silent = false) {
  if (!silent) {
    updateProgress(progressBar, null, "Prüfe 1Password CLI...")
  }
